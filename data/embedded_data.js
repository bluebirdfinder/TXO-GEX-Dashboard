window.GEX_EMBEDDED_DATA = {
  ...
  "session_shift": {
    ...
    "day_gex_plus_flip": 47229.5,
    "day_total_vex": 76.83
  },
  "last_updated_time": "2026-09-25 00:52",
  "spot_price": 48024.6,
  "spot_change": -132.69,
  ...
  "executive_digest": {
    ...
    "settlement_outlook": "🔮 <strong>結算展望與操作指南 (Trading Guide)</strong>：現價 (<code>47,909.0</code>) 處於 Zero Gamma (<code>47,137.2 點</code>) 上方之「正 Gamma 波動度抑制區」。若指數守穩 <code>47,500.0 點</code> Put Wall，做市商對沖買盤護盤持續，拉回尋求支撐；衝高接近 <code>48,000.0 點</code> Call Wall 壓力區宜逢高分批停利。"
  },
  "microstructure_summary": {
    ...
    "theme_color": "bull",
    "flip_dist": 771.8,
    "full_html": "\n        <p style=\"margin-bottom: 8px; line-height: 1.7; font-size: 0.88rem;\"><span style=\"color: var(--call-color); font-weight: 600;\">🛡️ 標的物價格 (47,909.0) 高於 Zero Gamma 轉折點 (47,137.2)</span>，做市商採逆風低買高賣對沖，盤勢傾向區域震盪與回測看撐。</p>\n        <p style=\"margin-bottom: 8px; line-height: 1.7; font-size: 0.88rem;\">📏 <strong>轉折距離位移</strong>：價格距 Gamma 轉折點 (<span style=\"color: var(--primary-accent); font-weight:700;\">47,137.2 點</span>) 相差 <span style=\"color: var(--gold-accent); font-weight:700;\">771.8 點</span>。</p>\n        <p style=\"margin-bottom: 0; line-height: 1.7; font-size: 0.88rem;\">🛑 <strong>Call Wall 賣壓牆</strong>：天花板位於 <span style=\"color: var(--gold-accent); font-weight: 700;\">48,000.0 點</span> (距現價 91 點)。 &nbsp; 🛡️ <strong>Put Wall 支撐牆</strong>：地板位於 <span style=\"color: var(--primary-accent); font-weight: 700;\">47,500.0 點</span> (距現價 409 點)。</p>\n        "
  },
  "hot_money_digest": {
    "current_fx": {
      "usdtwd": {
  ...
  "total_vex": 43.38,
  "total_gex_val": 539.09,
  "total_gex_plus": 582.46,
  "sector_capital_rotation": {
    "title": "📊 證交所 33 大產業歸納 8 大精準主題資金輪動矩陣",
    "last_updated": "2026-09-25 00:52",
    "sectors": [
      {
        "name": "💻 半導體與晶圓代工",
        "code": "semicon_tech",
  ...
  "macro_events_radar": {
    ...
    "macro_risk_dashboard": {
      "summary": "台指VIX 23.1、美股VIX 15.6；DXY/US10Y/VIX 即時報價僅供總經氛圍參考，非量化交易訊號。",
      "dxy": {
        "name": "美元指數 (DXY)",
        "price": 101.17,
        "change_pct": 0.07,
