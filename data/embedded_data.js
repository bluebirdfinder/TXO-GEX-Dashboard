window.GEX_EMBEDDED_DATA = {
  ...
  "last_updated_time": "2026-09-24 16:08",
  "spot_price": 48024.6,
  "spot_change": -132.69,
  ...
  "institutional_5day_history": [
    {
      ...
      "dealer_fut_net": -1520,
      "foreign_stock_net": -338.02,
      "trust_stock_net": -114.09,
      "itrust_stock_net": -114.09,
      "dealer_stock_net": 13.39,
      "total_stock_net": -438.73,
  ...
  "executive_digest": {
    ...
    "cash_summary": "💰 <strong>現貨買賣超動向 (Cash Market Audit)</strong>：三大法人現貨合計買賣超 <code>-438.73 億 TWD</code>！其中「外資 <code>-338.02 億</code>」、「投信 <code>-114.09 億</code>」與「自營商 <code>+13.39 億</code>」。",
  ...
  "hot_money_digest": {
    ...
    "hot_money_summary_html": "\n    <div class=\"hot-money-card bear\" style=\"padding: 14px 18px;\">\n        <h4 style=\"margin: 0 0 6px 0; color: var(--gold-accent); font-size: 1.05rem; display: flex; align-items: center; gap: 8px;\">\n            <span>🌐 國際熱錢動向與匯率趨勢解讀 (Hot Money Digest)</span>\n        </h4>\n        <p style=\"margin-bottom: 6px; font-size: 0.95rem; line-height: 1.6;\"><strong>⚠️ <span style=\"color: var(--put-color); font-weight: 700;\">台幣呈現貶值 (資金流出避險)</span></strong></p>\n        <p style=\"font-size: 0.88rem; line-height: 1.65; color: var(--text-main); margin-bottom: 12px;\">美元/台幣目前為 <span style=\"color: var(--gold-accent); font-weight: 700;\">31.84</span>（單日貶值 <span style=\"color: var(--put-color); font-weight: 700;\">+0.12 元</span>）。外資拋售台幣換回美金提款，防範大盤拉回賣壓。</p>\n        <div style=\"display: flex; gap: 20px; flex-wrap: wrap; font-size: 0.85rem; background: rgba(0,0,0,0.25); padding: 8px 12px; border-radius: 6px;\">\n            <span>💵 <strong>美元指數 (DXY)</strong>: <code>101.05</code> (全球資金吸鐵石)</span>\n            <span>💴 <strong>美元/日圓 (USD/JPY)</strong>: <code>157.96</code> (套利平倉風險指標)</span>\n        </div>\n    </div>\n    "
  },
