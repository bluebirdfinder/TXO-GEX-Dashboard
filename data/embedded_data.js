window.GEX_EMBEDDED_DATA = {
  ...
  "session_shift": {
    ...
    "call_wall_shift": -100,
    "put_wall_shift": -100,
    "zero_gamma_shift": -98.4,
    "gex_plus_flip_shift": -98.4,
    "vex_shift": 0.0,
    "day_txf_price": 48123.0,
    "day_call_wall": 47200,
    "day_put_wall": 47200,
    "day_zero_gamma": 47973.0,
    "day_max_pain": 47200,
    "day_gex_plus_flip": 48023.0,
    "day_total_vex": 0.0
  },
  "last_updated_time": "2026-09-25 01:49",
  "spot_price": 48024.6,
  "spot_change": -132.69,
  ...
  "txf_price": 47909.0,
  "zero_gamma_level": 47874.6,
  "gex_plus_flip": 47924.6,
  "call_wall_strike": 47100,
  "put_wall_strike": 47100,
  "max_pain_strike": 47100,
  "opt_large_trader": {
    "call": {
      "week": {
        "top5_net": -5290,
  ...
  "history_10_sessions": [
    ...
    },
    {
      ...
      "two_price": 412.99,
      "txf_price": 48123.0,
      "zero_gamma_level": 47973.0,
      "gex_plus_flip": 48023.0,
      "call_wall_strike": 47200,
      "put_wall_strike": 47200,
      "max_pain_strike": 47200,
      "shift_vs_prev": -374.0,
      "pc_ratio": 108.5,
  ...
  "executive_digest": {
    ...
    "options_structure": "🎯 <strong>選擇權莊家結構 (Options Matrix)</strong>：外資 Call 買權 <code>-1.80 億</code> 與 Put 賣權 <code>+0.26 億</code>；投信買權 <code>-5.05 億</code>。全場 <strong>Call Wall 天花板</strong> 鎖在 <code>47,100 點</code>，<strong>Put Wall 地板</strong> 固守於 <code>47,100 點</code>。",
    "sentiment_audit": "📊 <strong>籌碼體質與散戶比率 (Sentiment Audit)</strong>：小台與微台散戶指標維繫避險運作。全市場 P/C Ratio 站在 <code>108.5%</code> (🔴 偏多看撐)，莊家下檔防守支撐力道尚存。",
    "settlement_outlook": "🔮 <strong>結算展望與操作指南 (Trading Guide)</strong>：現價 (<code>47,909.0</code>) 處於 Zero Gamma (<code>47,874.6 點</code>) 上方之「正 Gamma 波動度抑制區」。若指數守穩 <code>47,100 點</code> Put Wall，做市商對沖買盤護盤持續，拉回尋求支撐；衝高接近 <code>47,100 點</code> Call Wall 壓力區宜逢高分批停利。"
  },
  "microstructure_summary": {
    ...
    "theme_color": "bull",
    "flip_dist": 34.4,
    "full_html": "\n        <p style=\"margin-bottom: 8px; line-height: 1.7; font-size: 0.88rem;\"><span style=\"color: var(--call-color); font-weight: 600;\">🛡️ 標的物價格 (47,909.0) 高於 Zero Gamma 轉折點 (47,874.6)</span>，做市商採逆風低買高賣對沖，盤勢傾向區域震盪與回測看撐。</p>\n        <p style=\"margin-bottom: 8px; line-height: 1.7; font-size: 0.88rem;\">⚡ <strong>轉折臨界告急</strong>：價格距離 Gamma 轉折點 (<span style=\"color: var(--primary-accent); font-weight:700;\">47,874.6 點</span>) 僅 <span style=\"color: var(--gold-accent); font-weight:700;\">34.4 點</span>，處於變盤臨界邊緣。</p>\n        <p style=\"margin-bottom: 0; line-height: 1.7; font-size: 0.88rem;\">🚀 <strong>Call Wall 已突破</strong>：現價 (<span style=\"color: var(--call-color); font-weight:700;\">47,909.0</span>) 已突破天花板 <span style=\"color: var(--gold-accent); font-weight:700;\">47,100 點</span>，引爆伽瑪擠壓 (Gamma Squeeze) 強勢軋空！ &nbsp; 🛡️ <strong>Put Wall 支撐牆</strong>：地板位於 <span style=\"color: var(--primary-accent); font-weight: 700;\">47,100 點</span> (距現價 809 點)。</p>\n        "
  },
  "hot_money_digest": {
    "current_fx": {
      "usdtwd": {
  ...
  "ai_ex_dividend_digest": {
    ...
    "bullet_1": "🎯 <strong>台指大盤 GEX 位階與動態判讀 (<span style=\"color: var(--gold-accent); font-weight:700;\">47,909.00 點</span>)</strong>：台指現價 <span style=\"color: var(--gold-accent); font-weight:700;\">47,909.00 點</span>，對照 Zero Gamma 轉折點 (<span style=\"color: var(--primary-accent); font-weight:700;\">47,874.6 點</span>)，總 GEX 處於 <span style=\"color: var(--call-color); font-weight:700;\">正 GEX 護盤區</span>。若持續守穩 <span style=\"color: var(--primary-accent); font-weight:700;\">47,100 點 Put Wall 支撐</span>，莊家對沖護盤力道將維繫常態盤整。",
    "bullet_2": "🧱 <strong>週月選莊家牆與結算位階 (<span style=\"color: var(--gold-accent); font-weight:700;\">47,100 / 47,100</span>)</strong>：週月選主力天花板集中於 <span style=\"color: var(--gold-accent); font-weight:700;\">47,100 點</span> (Call Wall 週月選衝高壓力柱)；波段防守鐵板位於 <span style=\"color: var(--primary-accent); font-weight:700;\">47,100 點</span> (Put Wall 避險防守柱)；結算前夕宜注意轉折點 <span style=\"color: var(--gold-accent); font-weight:700;\">47,874.6 點</span> 之磁吸震盪點位。",
    "bullet_3": "🔥 <strong>Top 10 期交所真實成交量焦點標的</strong>：中信高評級公司債ETF期 (00772B) 與 廣明期 (6188) 為期交所個股期貨成交量前列標的，展現個股期貨交投熱度與動態資金趨勢。",
  ...
  "macro_events_radar": {
    ...
    "macro_risk_dashboard": {
      "summary": "台指VIX 23.1、美股VIX 15.7；DXY/US10Y/VIX 即時報價僅供總經氛圍參考，非量化交易訊號。",
      "dxy": {
        "name": "美元指數 (DXY)",
        "price": 101.3,
        "change_pct": 0.21,
