window.GEX_EMBEDDED_DATA = {
  ...
  "history_10_sessions": [
    ...
    },
    {
      ...
      "label": "🔥 T夜盤 (Live)",
      "date_display": "9/24 (四) 🌙",
      "full_name": "9/24 (四) T夜盤 (Live 即時動態)",
      "spot_price": 47909.0,
      "two_price": 412.99,
      "txf_price": 47909.0,
      "zero_gamma_level": 47137.5,
  ...
  "institutional_sentiment": {
    ...
    "daily_change": -77031,
    "notional_billion": 7381.0,
    "description": "外資單日重手加空 -77,031 口（約 -7381.0 億 TWD 契約金額），高檔下檔避險風險飆升。"
  },
  "executive_digest": {
    "futures_summary": "📈 <strong>期貨籌碼動向 (Futures Audit)</strong>：前五大淨部位 <code>+19,625 口</code>、前十大 <code>+5,941 口</code>，特定法人淨部位 <code>+19,625 口</code>。外資台指期未平倉空單 <code>-77,031 口</code>（單日變動 <code>-77,031 口</code>，約合 <code>7381.0 億 TWD</code> 契約金額）。⚠️ 暴增高檔避險 / 重手加空。",
    "cash_summary": "💰 <strong>現貨買賣超動向 (Cash Market Audit)</strong>：三大法人現貨合計買賣超 <code>-444.49 億 TWD</code>！其中「外資 <code>-329.65 億</code>」、「投信 <code>-128.23 億</code>」與「自營商 <code>+13.39 億</code>」。",
    ...
    "settlement_outlook": "🔮 <strong>結算展望與操作指南 (Trading Guide)</strong>：現價 (<code>47,909.0</code>) 處於 Zero Gamma (<code>47,137.5 點</code>) 上方之「正 Gamma 波動度抑制區」。若指數守穩 <code>47,500.0 點</code> Put Wall，做市商對沖買盤護盤持續，拉回尋求支撐；衝高接近 <code>48,000.0 點</code> Call Wall 壓力區宜逢高分批停利。"
  },
  "microstructure_summary": {
    ...
    "theme_color": "bull",
    "flip_dist": 771.5,
    "full_html": "\n        <p style=\"margin-bottom: 8px; line-height: 1.7; font-size: 0.88rem;\"><span style=\"color: var(--call-color); font-weight: 600;\">🛡️ 標的物價格 (47,909.0) 高於 Zero Gamma 轉折點 (47,137.5)</span>，做市商採逆風低買高賣對沖，盤勢傾向區域震盪與回測看撐。</p>\n        <p style=\"margin-bottom: 8px; line-height: 1.7; font-size: 0.88rem;\">📏 <strong>轉折距離位移</strong>：價格距 Gamma 轉折點 (<span style=\"color: var(--primary-accent); font-weight:700;\">47,137.5 點</span>) 相差 <span style=\"color: var(--gold-accent); font-weight:700;\">771.5 點</span>。</p>\n        <p style=\"margin-bottom: 0; line-height: 1.7; font-size: 0.88rem;\">🛑 <strong>Call Wall 賣壓牆</strong>：天花板位於 <span style=\"color: var(--gold-accent); font-weight: 700;\">48,000.0 點</span> (距現價 91 點)。 &nbsp; 🛡️ <strong>Put Wall 支撐牆</strong>：地板位於 <span style=\"color: var(--primary-accent); font-weight: 700;\">47,500.0 點</span> (距現價 409 點)。</p>\n        "
  },
  "hot_money_digest": {
    "current_fx": {
      "usdtwd": {
  ...
  "macro_events_radar": {
    ...
    "macro_risk_dashboard": {
      "summary": "台指VIX 23.1、美股VIX 16.0；DXY/US10Y/VIX 即時報價僅供總經氛圍參考，非量化交易訊號。",
      "dxy": {
        "name": "美元指數 (DXY)",
        "price": 101.27,
        "change_pct": 0.17,
  ...
  "vix_info": {
    ...
    "tail_risk_status": "VIX (23.12) 與 VVIX (88.60) 同步對齊，🟢 風穩常態",
