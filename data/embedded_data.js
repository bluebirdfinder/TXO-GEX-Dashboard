window.GEX_EMBEDDED_DATA = {
  ...
  "last_updated_time": "2026-08-29 10:34",
  "spot_price": 46331.45,
  "spot_change": 356.23,
  ...
  "executive_digest": {
    ...
    "settlement_outlook": "🔮 <strong>結算展望與操作指南 (Trading Guide)</strong>：現價 (<code>46,331.45</code>) 處於 Zero Gamma (<code>46,317.7 點</code>) 上方之「正 Gamma 波動度抑制區」。若指數守穩 <code>46,100 點</code> Put Wall，做市商對沖買盤護盤持續，拉回尋求支撐；衝高接近 <code>46,500 點</code> Call Wall 壓力區宜逢高分批停利。"
  },
  "microstructure_summary": {
    "regime_label": "🟢 負 Gamma 波動度放大區 (避險引爆)",
    "theme_color": "bear",
    "flip_dist": 417.7,
    "full_html": "\n        <p style=\"margin-bottom: 8px; line-height: 1.7; font-size: 0.88rem;\"><strong>🟢 負 Gamma 波動度放大區 (避險引爆)</strong> - <span style=\"color: var(--put-color); font-weight: 700;\">⚠️ 警告！標的價格 (45900.0) 低於 Zero Gamma 轉折點 (46317.7)</span>，做市商順風追跌殺跌，盤中波動度恐劇烈飆升！</p>\n        <p style=\"margin-bottom: 8px; line-height: 1.7; font-size: 0.88rem;\">📏 <strong>轉折安全距離</strong>：價格距 Gamma 轉折點 (<span style=\"color: var(--primary-accent); font-weight:700;\">46317.7 點</span>) 尚有 <span style=\"color: var(--gold-accent); font-weight:700;\">417.7 點</span>緩衝防守區。</p>\n        <p style=\"margin-bottom: 0; line-height: 1.7; font-size: 0.88rem;\">🛑 <strong>Call Wall 賣壓牆</strong>：天花板位於 <span style=\"color: var(--gold-accent); font-weight: 700;\">46500 點</span> (<span style=\"color: var(--gold-accent); font-weight:600;\">-100點</span>)。 &nbsp; 🛡️ <strong>Put Wall 支撐牆</strong>：地板位於 <span style=\"color: var(--primary-accent); font-weight: 700;\">46100 點</span> (<span style=\"color: var(--primary-accent); font-weight:600;\">-100點</span>)。</p>\n        "
  },
  "hot_money_digest": {
    "current_fx": {
      "usdtwd": {
